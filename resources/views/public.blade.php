                    ...
                    <div class="row">
                        <div class="container">
                            ...
                            <div class="col-md-5 text-right">
                                <img style="max-width: 200px;" data-animation="animated zoomInLeft"
                                     src="http://s20.postimg.org/sp11uneml/rack_server_unlock.png">
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="container">
                            <div class="col-md-7 text-left">
                                ...
                                <h4 data-animation="animated bounceInUp">Bootstrap Image Carousel Slider with
                                    Animate.css</h4>
                            </div>
                            <div class="col-md-5 text-right">
                                <img style="max-width: 200px;" data-animation="animated zoomInLeft"
                                     src="http://s20.postimg.org/eq8xvxeq5/globe_network.png">
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="item slide4">
                    <div class="row">
                        <div class="container">
                            ...
                            <div class="col-md-5 text-right">
                                <img style="max-width: 200px;" data-animation="animated zoomInLeft"
                                     src="http://s20.postimg.org/9vf8xngel/internet_speed.png">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-4">
                <div class="card">
                    <div class="card-image">
                        ...
                        <span class="card-title">{{ $b->code_no }}</span>
                    </div>

                    <div class="card-content">
                        <p>{{ str_limit(($b->name), 35, '...') }}</p>
                    </div>
